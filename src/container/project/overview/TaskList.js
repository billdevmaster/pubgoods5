...
function TaskList() {
  ...
  const dataSource = [
    {
      key: '1',
      title: <span className="task-title">DAO Operator Residency Cohort 2</span>,
      component: (
        <TasklistAction>
    ...
    {
      key: '4',
      title: <span className="task-title">Grant Application</span>,
      component: (
        <TasklistAction>
          <span className="task-created">09:20 AM </span>
          <img
    ...
    {
      key: '5',
      title: <span className="task-title">Product Development Milestone</span>,
      component: (
        <TasklistAction>
          <span className="task-created">09:20 AM </span>
          <img
    ...
    {
      key: '6',
      title: <span className="task-title">Create Framework & infra </span>,
      component: (
        <TasklistAction>
          <span className="task-created">09:20 AM </span>
          <img
